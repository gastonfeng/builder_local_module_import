...
om = build_odoo('builder_local_module_import', "1.0", git=gits('builder_local_module_import', url='ssh://kaikong@192.168.31.10/home/git/odoo_builder.git'),newTests=['test11'],oldTests=['odoo11'],
